import type { layoutConfigInterface } from '@/layout/composables/layout';
...
export function getPaletteByName(name: string) {
    const color = primaryColors.value.find((c) => c.name === name);
...
export function getPresetExt(layoutConfig: layoutConfigInterface) {
...
export const presets = { Aura, Lara, Nora };

export function changePreset(layoutConfig: layoutConfigInterface, preset: string) {
