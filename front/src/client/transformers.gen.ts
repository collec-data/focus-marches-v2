...
import type { GetConcessionResponse, GetErreursImportResponse, GetListeConcessionsResponse, GetListeMarchesResponse, GetMarcheResponse, GetStructureResponse } from './types.gen';
