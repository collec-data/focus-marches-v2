...
import type { GetConcessionResponse, GetErreursImportResponse, GetListeConcessionsResponse, GetListeMarchesResponse, GetMarcheResponse, GetStructureIdResponse, GetStructureResponse } from './types.gen';

const decpMalFormeDtoSchemaResponseTransformer = (data: any) => {
...
export const getErreursImportResponseTransformer = async (data: any): Promise<GetErreursImportResponse> => {
    data = data.map((item: any) => decpMalFormeDtoSchemaResponseTransformer(item));
    return data;
};
...
export const getStructureIdResponseTransformer = async (data: any): Promise<GetStructureIdResponse> => {
    data = structureEtendueDtoSchemaResponseTransformer(data);
    return data;
};
