...
onMounted(() => {
    getIndicateursMarcheIndicateursGet().then((data) => (indicateurs.value = data.data));
});
</script>
    ...
    <section class="key-indicators">
        ...
        <div class="indicators-grid">
            <div class="indicator">
                <div class="icon">
                    <!-- Calendar SVG -->
                    <svg width="40" height="40" fill="#7ed6f7" viewBox="0 0 24 24">
                        <rect x="3" y="5" width="18" height="16" rx="2" />
                        <path d="M16 3v4M8 3v4M3 9h18" stroke="#7ed6f7" stroke-width="2" fill="none" />
                    </svg>
                </div>
            ...
            <div class="indicator">
                <div class="icon">
                    <!-- Handshake SVG -->
                    <svg width="40" height="40" fill="#7ed6f7" viewBox="0 0 24 24">
                        <path d="M17 13l4-4a2 2 0 0 0-2.8-2.8l-4 4" stroke="#7ed6f7" stroke-width="2" fill="none" />
                        <path d="M7 11l-4-4a2 2 0 0 1 2.8-2.8l4 4" stroke="#7ed6f7" stroke-width="2" fill="none" />
                        <path d="M8 12l4 4 4-4" stroke="#7ed6f7" stroke-width="2" fill="none" />
                    </svg>
                </div>
            ...
            <div class="indicator">
                <div class="icon">
                    ...
                    <svg width="40" height="40" fill="#7ed6f7" viewBox="0 0 24 24">
                        ...
                        <path d="M2 20c0-4 8-6 10-6s10 2 10 6" stroke="#7ed6f7" stroke-width="2" fill="none" />
                    </svg>
                </div>
