<template>
    <section class="category-distribution">
        ...
        <p class="subtitle">Comparaison des trois catégories d'achats (zone colorée) par rapport au total (zone grise).</p>
        <div class="charts-row">
            <div v-for="cat in categories" :key="cat.key" class="chart-block">
                <h3 class="chart-title">{{ cat.label }}</h3>
                <Chart type="line" :data="cat.chartData" :options="chartOptions(cat.color)" class="category-chart" />
                <div class="stats-row">
                    <div class="stats-box">
