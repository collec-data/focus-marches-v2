...
function initEChart() {
    ...
    myChartInstance.value = echarts.init(el);

    const option = {
        title: { text: '(ECharts) example', left: 'center' },
        tooltip: {},
        ...
        series: [
            {
                name: 'Example',
                type: 'line',
                data: [127, 200, 150, 80, 70, 110, 130]
            }
        ]
    };
    ...
    const resizeHandler = () => {
        myChartInstance.value && myChartInstance.value.resize();
    };
...
<template>
    <Fluid class="grid grid-cols-12 gap-8">
        <div class="col-span-12">
            <div class="card">
                <div class="font-semibold text-xl mb-4">ECharts</div>
